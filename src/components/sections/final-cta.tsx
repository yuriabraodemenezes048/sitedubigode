  ...
  return (
    ...
    >
      ...
      <div className="shell relative z-10 py-24 text-center">
        <p className="kicker mx-auto w-fit text-paper/50 before:bg-paper/40 after:hidden">
        ...
        <p className="mx-auto mt-7 max-w-xl text-base leading-relaxed text-paper/70 sm:text-lg">
        ...
        <div className="mt-10 flex flex-col items-center justify-center gap-3 sm:flex-row">
          <Link
            href="/orcamento"
            className="group inline-flex h-14 items-center justify-center gap-2 rounded-full bg-paper px-9 text-[0.95rem] font-semibold text-ink transition-all duration-500 ease-out-expo hover:-translate-y-0.5 hover:bg-flame hover:text-paper"
          >
            Solicitar orçamento
          ...
          <a
            ...
            className="inline-flex h-14 items-center justify-center gap-2 rounded-full border border-paper/25 px-9 text-[0.95rem] font-semibold text-paper transition-colors hover:bg-paper hover:text-ink"
          >
            Falar no WhatsApp
          </a>
        </div>
